...
const (
	...
	copyTraySettings           = "tray.settings"
	copyTrayShowMain           = "tray.show_main"
	copyTrayQuit               = "tray.quit"
)
...
var desktopCopy = map[Locale]map[string]string{
	LocaleEN: {
		...
		copyTraySettings:           "Settings",
		copyTrayShowMain:           "Show Octop",
		copyTrayQuit:               "Quit",
	},
	LocaleZH: {
