---
name: octop-electron-green
description: >-
  Integrate Octop green portable zip into Electron: download Octop-<plat>.zip,
  extract, spawn launch.py, OCTOP_HOME, health check, quarantine, pywintypes.
  Use when embedding Octop backend in Electron or another desktop shell.
---
