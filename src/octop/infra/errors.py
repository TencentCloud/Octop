...
class ErrorCode(StrEnum):
    ...
    LDAP_BAD_REQUEST = "LDAP_BAD_REQUEST"
    LDAP_UNAVAILABLE = "LDAP_UNAVAILABLE"
    LDAP_USER_NOT_PROVISIONED = "LDAP_USER_NOT_PROVISIONED"
...
_DEFAULT_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.LDAP_BAD_REQUEST: 400,
    ErrorCode.LDAP_UNAVAILABLE: 502,
    ErrorCode.LDAP_USER_NOT_PROVISIONED: 403,
