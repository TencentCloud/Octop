...
class ErrorCode(StrEnum):
    ...
    EXPERT_TEMPLATE_EXISTS = "EXPERT_TEMPLATE_EXISTS"
    EXPERT_TEMPLATE_INVALID = "EXPERT_TEMPLATE_INVALID"
    EXPERT_TEMPLATE_PUBLISH_FAILED = "EXPERT_TEMPLATE_PUBLISH_FAILED"
...
_DEFAULT_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.EXPERT_TEMPLATE_EXISTS: 409,
    ErrorCode.EXPERT_TEMPLATE_INVALID: 400,
    ErrorCode.EXPERT_TEMPLATE_PUBLISH_FAILED: 500,
